...
struct mmi_pmic_info {
	...
	int icl_result_ma;
	int vfloat_mv;
<<<<<<< HEAD:motorola/drivers/power/mmi_glink_charger/mmi_glink_core.h
	int chrg_stat;
=======
	int pmic_suspend_st;
>>>>>>> d944516346 (mmi_glink_charger: Report the information of PMIC):drivers/power/mmi_glink_charger/mmi_glink_core.h
};
