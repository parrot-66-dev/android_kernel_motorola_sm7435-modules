...
else ifneq (,$(filter lamy, $(TARGET_PRODUCT)))
include $(CAMERA_KERNEL_ROOT)/config/lamy.mk
else ifneq (,$(filter lamy_factory, $(TARGET_PRODUCT)))
include $(CAMERA_KERNEL_ROOT)/config/lamy_factory.mk
endif
